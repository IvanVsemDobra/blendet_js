...
// варіант №1
// const min = Number(prompt("Введи число від 0 до 59"));
// let quarter;
//
// if (min >= 0 && min <= 14) {
//   quarter = 'перша';
...
function isAdult(age) {
    if (age >= 18) {
      ...
      return confirm("Вам менше 18 років. Підтвердіть, будь ласка.");
    }
  }
  
  // Приклад виклику:
  const userAge = Number(prompt("Введіть свій вік:"));
  const result = isAdult(userAge);
  console.log(result);
